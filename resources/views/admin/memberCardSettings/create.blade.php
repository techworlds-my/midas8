...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.memberCardSetting.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.member-card-settings.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('format') ? 'is-invalid' : '' }}" type="text" name="format" id="format" value="{{ old('format', '') }}" required>
