    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.point-settings.update", [$pointSetting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('point_ratio') ? 'is-invalid' : '' }}" type="number" name="point_ratio" id="point_ratio" value="{{ old('point_ratio', $pointSetting->point_ratio) }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_enable') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="is_enable" id="is_enable" value="1" {{ $pointSetting->is_enable || old('is_enable', 0) === 1 ? 'checked' : '' }} required>
