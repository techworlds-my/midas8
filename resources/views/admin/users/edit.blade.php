    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_credit') ? 'is-invalid' : '' }}" type="number" name="total_credit" id="total_credit" value="{{ old('total_credit', $user->total_credit) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_credit') ? 'is-invalid' : '' }}" type="number" name="current_credit" id="current_credit" value="{{ old('current_credit', $user->current_credit) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_point') ? 'is-invalid' : '' }}" type="number" name="total_point" id="total_point" value="{{ old('total_point', $user->total_point) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_point') ? 'is-invalid' : '' }}" type="number" name="current_point" id="current_point" value="{{ old('current_point', $user->current_point) }}" step="1">
