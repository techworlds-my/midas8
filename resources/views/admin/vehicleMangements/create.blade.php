...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.vehicleMangement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.vehicle-mangements.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('driver_count') ? 'is-invalid' : '' }}" type="number" name="driver_count" id="driver_count" value="{{ old('driver_count', '') }}" step="1">
